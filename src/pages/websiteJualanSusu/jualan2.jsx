...
import Navbar from "../../component/navbar/navbar_jualan _2";
        ...
        <div >
          ...
          <div>
            {/* <form className="form_pembelian">
              ...
              <input placeholder="Nama" className="form-control" type="text" value={nama} onChange={((e)=> setNama(e.target.value))} required/>
              <label>Nomor Whatshapp/Nomor Hp <span className="text-danger">*</span></label>
              <input placeholder="Nomor Whatsaap" className="form-control" type="number" value={no_whatsap} onChange={((e)=> setwhatshapp(e.target.value))} required/>
              <label>Jumlah <span className="text-danger">*</span></label>
              <input placeholder="Jumlah" className="form-control" type="number" value={jumlah} onChange={((e)=> setJumlah(e.target.value))} required/>

            
              <label>Jalan <span className="text-danger">*</span></label>
              <input placeholder="Jln mawar no 8" className="form-control" type="text" value={address.jalan} name='jalan' onChange={addressDetail} required/>

              <label>RT <span className="text-danger">*</span></label>
              <input placeholder="00" className="form-control" type="text" value={address.RT} name='RT' onChange={addressDetail} required/>

              <label>RW <span className="text-danger">*</span></label>
              <input placeholder="00" className="form-control" type="text" value={address.RW} name='RW' onChange={addressDetail} required/>

              <label>Kecamatan/kelurahan <span className="text-danger">*</span></label>
              <input placeholder="" className="form-control" type="text" value={address.kecamatan} name='kecamatan' onChange={addressDetail} required/>

              <label>Kabupaten <span className="text-danger">*</span></label>
              <input placeholder="" className="form-control" type="text" value={address.kabupaten} name='kabupaten' onChange={addressDetail} required/>

              <label>Kota <span className="text-danger">*</span></label>
              <input placeholder="" className="form-control" type="text" value={address.kota} name='kota' onChange={addressDetail} required/>
